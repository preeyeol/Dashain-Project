...
//     eventSchema
//       .insertMany(dashainEvents)
//       .then(async () => {
//         console.log("Connected to MongoDB");

//         // Check if Dashain events already exist
...
//           if (eventSchema === existingEvent) {
//             console.log(`Event already exists: ${event.title}`);
//           }
//         }

//         mongoose.disconnect();
//         console.log("Finished inserting Dashain events");
//       })
//       .catch((err) => {
//         console.error("Error inserting Dashain events:", err);
//         mongoose.disconnect();
//       });
//   })
//   .catch((err) => {
